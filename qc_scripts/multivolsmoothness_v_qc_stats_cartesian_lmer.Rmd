...
q7.test <- lmer(qc ~ fwhm.cen + pipeline + (1 | subject), data=q7)
summary(q7.test)
...
csdsi.test <- lmer(qc ~ fwhm.cen + pipeline + (1 | subject), csdsi)
summary(csdsi.test)
...
crash.test <- lmer(qc ~ fwhm.cen + pipeline + (1 | subject), crash)
summary(crash.test)
