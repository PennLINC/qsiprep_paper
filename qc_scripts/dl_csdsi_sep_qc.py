...
failed_analyses = []
out_dir = "/Users/mcieslak/projects/writing/qsiprep_paper/qc_scripts/csdsi_tsvs"
...
glymphatic_df.to_csv("csdsi_qc.csv", index=False)
