...
fw = flywheel.Client()
proj = fw.projects.find_first("label=ReproBrainChart")
analyses = fw.get_analyses('projects', proj.id, 'sessions')
qsiprep_results = [ana for ana in analyses if
                   ana.label.startswith("washU_QCscorecomp_qsiprep_0.3.17_0.8.0")]
...
failed_analyses = []
out_dir = "/Users/mcieslak/projects/writing/qsiprep_paper/qc_scripts/hbn_tsvs"
...
glymphatic_df.to_csv("hbn_qsiprep_qc.csv", index=False)
